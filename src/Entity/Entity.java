...
public class Entity {
    ...
    public int actionLockedCounter = 0;
    ...
    public void dropItem(Entity droppedItem){
        ...
        for(int i = 0; i < gp.objs[1].length; i++){
            if(gp.objs[gp.currentMap][i] == null){
                ...
                gp.objs[gp.currentMap][i].worldX = worldX; // the dead monster worldX
                gp.objs[gp.currentMap][i].worldY = worldY;
                break;
            }
    ...
    public String getOppositeDirection(String direction){
     ...
     public void attacking(){
        ...
        if(spriteCounter > motion1_duration &&  spriteCounter <= motion2_duration){
            ...
            // Adjust player worldX, worldY, and solidArea
            switch(direction){
            ...
            // After checking collisions, resorts the original data
    ...
    public void changeAlpha(Graphics2D g2, float alphaValue){
     ...
     public void searchPath(int goalCol, int goalRow){
         ...
         if(gp.pFinder.search() == true){
             ...
             // If reaches the goal, stops the search

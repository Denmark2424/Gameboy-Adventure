    ...
    public int checkObject(Entity entity, boolean player){
        ...
        for (int i = 0; i < gp.objs[1].length; i++){
            ...
            if(gp.objs[gp.currentMap][i] != null){
                ...
                gp.objs[gp.currentMap][i].solidArea.x = gp.objs[gp.currentMap][i].worldX + gp.objs[gp.currentMap][i].solidArea.x;
                gp.objs[gp.currentMap][i].solidArea.y = gp.objs[gp.currentMap][i].worldY + gp.objs[gp.currentMap][i].solidArea.y;
                ...
                if(entity.solidArea.intersects(gp.objs[gp.currentMap][i].solidArea)){
